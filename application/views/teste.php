...
<head>
    ...
    <link rel="stylesheet" href="https://www.jqueryscript.net/demo/kanban-board-app/style.css">
    ...
    <title>Kanban Board App Example</title>
<body>
    ...
    <div class="controls p-3">
        <form class="form-inline">
            ...
            <button class="btn btn-success mx-2" id="deleteAll">Delete All</button>
    ...
    <script src="https://www.jqueryscript.net/demo/kanban-board-app/script.js" defer></script>
